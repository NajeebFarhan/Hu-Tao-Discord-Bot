...
COMMANDS: list[commands.Command] = [test, chat, ping, deletechat, deleteall, history, view, channel, gen_openai_key, remote_chat, remote_reply, remote_edit, remote_delete, remote_delete_last, remote_pin, remote_reaction]